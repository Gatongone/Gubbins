...
public sealed class WeakActionEventHandler : IEventHandler, IWeakEventHandler, IEquatable<WeakActionEventHandler>
{
    ...
    public void Handle(Unit notification)
    {
        if (m_Owner.TryGetTarget(out var owner) && owner != null) m_Invocation.Invoke();
    }
...
public sealed class WeakActionEventHandler<T> : IEventHandler<T>, IWeakEventHandler<T>, IEquatable<WeakActionEventHandler<T>>
{
    ...
    {
        if (m_Owner.TryGetTarget(out var owner) && owner != null) m_Invocation.Invoke(param);
    }
...
public sealed class WeakActionEventHandler<T1, T2> : IEventHandler<(T1, T2)>, IWeakEventHandler<(T1, T2)>, IEquatable<WeakActionEventHandler<T1, T2>>
{
    ...
    /// <inheritdoc cref="IEventHandler{TNotification}.Handle"/>
    public void Handle((T1, T2) notification)
    {
        if (m_Owner.TryGetTarget(out var owner) && owner != null) m_Invocation.Invoke(notification.Item1, notification.Item2);
    }

    /// <inheritdoc cref="IEventHandler{TNotification}.Handle"/>
    public void Handle(T1 param1, T2 param2)
    {
        if (m_Owner.TryGetTarget(out var owner) && owner != null) m_Invocation.Invoke(param1, param2);
    }
...
public sealed class WeakActionEventHandler<T1, T2, T3> : IEventHandler<(T1, T2, T3)>, IWeakEventHandler<(T1, T2, T3)>, IEquatable<WeakActionEventHandler<T1, T2, T3>>
{
    ...
    /// <inheritdoc cref="IEventHandler{TNotification}.Handle"/>
    public void Handle((T1, T2, T3) notification)
    {
        if (m_Owner.TryGetTarget(out var owner) && owner != null) m_Invocation.Invoke(notification.Item1, notification.Item2, notification.Item3);
    }

    /// <inheritdoc cref="IEventHandler{TNotification}.Handle"/>
    public void Handle(T1 param1, T2 param2, T3 param3)
    {
        if (m_Owner.TryGetTarget(out var owner) && owner != null) m_Invocation.Invoke(param1, param2, param3);
    }
...
public sealed class WeakActionEventHandler<T1, T2, T3, T4> : IEventHandler<(T1, T2, T3, T4)>, IWeakEventHandler<(T1, T2, T3, T4)>, IEquatable<WeakActionEventHandler<T1, T2, T3, T4>>
{
    ...
    /// <inheritdoc cref="IEventHandler{TNotification}.Handle"/>
    public void Handle((T1, T2, T3, T4) notification)
    {
        if (m_Owner.TryGetTarget(out var owner) && owner != null) m_Invocation.Invoke(notification.Item1, notification.Item2, notification.Item3, notification.Item4);
    }

    /// <inheritdoc cref="IEventHandler{TNotification}.Handle"/>
    public void Handle(T1 param1, T2 param2, T3 param3, T4 param4)
    {
        if (m_Owner.TryGetTarget(out var owner) && owner != null) m_Invocation.Invoke(param1, param2, param3, param4);
    }
...
public sealed class WeakActionEventHandler<T1, T2, T3, T4, T5> : IEventHandler<(T1, T2, T3, T4, T5)>, IWeakEventHandler<(T1, T2, T3, T4, T5)>, IEquatable<WeakActionEventHandler<T1, T2, T3, T4, T5>>
{
    ...
    /// <inheritdoc cref="IEventHandler{TNotification}.Handle"/>
    public void Handle((T1, T2, T3, T4, T5) notification)
    {
        if (m_Owner.TryGetTarget(out var owner) && owner != null) m_Invocation.Invoke(notification.Item1, notification.Item2, notification.Item3, notification.Item4, notification.Item5);
    }

    /// <inheritdoc cref="IEventHandler{TNotification}.Handle"/>
    public void Handle(T1 param1, T2 param2, T3 param3, T4 param4, T5 param5)
    {
        if (m_Owner.TryGetTarget(out var owner) && owner != null) m_Invocation.Invoke(param1, param2, param3, param4, param5);
    }
...
public sealed class WeakActionEventHandler<T1, T2, T3, T4, T5, T6> : IEventHandler<(T1, T2, T3, T4, T5, T6)>, IWeakEventHandler<(T1, T2, T3, T4, T5, T6)>, IEquatable<WeakActionEventHandler<T1, T2, T3, T4, T5, T6>>
{
    ...
    /// <inheritdoc cref="IEventHandler{TNotification}.Handle"/>
    public void Handle((T1, T2, T3, T4, T5, T6) notification)
    {
        if (m_Owner.TryGetTarget(out var owner) && owner != null) m_Invocation.Invoke(notification.Item1, notification.Item2, notification.Item3, notification.Item4, notification.Item5, notification.Item6);
    }

    /// <inheritdoc cref="IEventHandler{TNotification}.Handle"/>
    public void Handle(T1 param1, T2 param2, T3 param3, T4 param4, T5 param5, T6 param6)
    {
        if (m_Owner.TryGetTarget(out var owner) && owner != null) m_Invocation.Invoke(param1, param2, param3, param4, param5, param6);
    }
...
public sealed class WeakActionEventHandler<T1, T2, T3, T4, T5, T6, T7> : IEventHandler<(T1, T2, T3, T4, T5, T6, T7)>, IWeakEventHandler<(T1, T2, T3, T4, T5, T6, T7)>, IEquatable<WeakActionEventHandler<T1, T2, T3, T4, T5, T6, T7>>
{
    ...
    /// <inheritdoc cref="IEventHandler{TNotification}.Handle"/>
    public void Handle((T1, T2, T3, T4, T5, T6, T7) notification)
    {
        if (m_Owner.TryGetTarget(out var owner) && owner != null) m_Invocation.Invoke(notification.Item1, notification.Item2, notification.Item3, notification.Item4, notification.Item5, notification.Item6, notification.Item7);
    }

    /// <inheritdoc cref="IEventHandler{TNotification}.Handle"/>
    public void Handle(T1 param1, T2 param2, T3 param3, T4 param4, T5 param5, T6 param6, T7 param7)
    {
        if (m_Owner.TryGetTarget(out var owner) && owner != null) m_Invocation.Invoke(param1, param2, param3, param4, param5, param6, param7);
    }
...
public sealed class WeakActionEventHandler<T1, T2, T3, T4, T5, T6, T7, T8> : IEventHandler<(T1, T2, T3, T4, T5, T6, T7, T8)>, IWeakEventHandler<(T1, T2, T3, T4, T5, T6, T7, T8)>, IEquatable<WeakActionEventHandler<T1, T2, T3, T4, T5, T6, T7, T8>>
{
    ...
    /// <inheritdoc cref="IEventHandler{TNotification}.Handle"/>
    public void Handle((T1, T2, T3, T4, T5, T6, T7, T8) notification)
    {
        if (m_Owner.TryGetTarget(out var owner) && owner != null) m_Invocation.Invoke(notification.Item1, notification.Item2, notification.Item3, notification.Item4, notification.Item5, notification.Item6, notification.Item7, notification.Item8);
    }

    /// <inheritdoc cref="IEventHandler{TNotification}.Handle"/>
    public void Handle(T1 param1, T2 param2, T3 param3, T4 param4, T5 param5, T6 param6, T7 param7, T8 param8)
    {
        if (m_Owner.TryGetTarget(out var owner) && owner != null) m_Invocation.Invoke(param1, param2, param3, param4, param5, param6, param7, param8);
    }
...
public sealed class WeakActionEventHandler<T1, T2, T3, T4, T5, T6, T7, T8, T9> : IEventHandler<(T1, T2, T3, T4, T5, T6, T7, T8, T9)>, IWeakEventHandler<(T1, T2, T3, T4, T5, T6, T7, T8, T9)>, IEquatable<WeakActionEventHandler<T1, T2, T3, T4, T5, T6, T7, T8, T9>>
{
    ...
    /// <inheritdoc cref="IEventHandler{TNotification}.Handle"/>
    public void Handle((T1, T2, T3, T4, T5, T6, T7, T8, T9) notification)
    {
        if (m_Owner.TryGetTarget(out var owner) && owner != null) m_Invocation.Invoke(notification.Item1, notification.Item2, notification.Item3, notification.Item4, notification.Item5, notification.Item6, notification.Item7, notification.Item8, notification.Item9);
    }

    /// <inheritdoc cref="IEventHandler{TNotification}.Handle"/>
    public void Handle(T1 param1, T2 param2, T3 param3, T4 param4, T5 param5, T6 param6, T7 param7, T8 param8, T9 param9)
    {
        if (m_Owner.TryGetTarget(out var owner) && owner != null) m_Invocation.Invoke(param1, param2, param3, param4, param5, param6, param7, param8, param9);
    }
...
public sealed class WeakActionEventHandler<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10> : IEventHandler<(T1, T2, T3, T4, T5, T6, T7, T8, T9, T10)>, IWeakEventHandler<(T1, T2, T3, T4, T5, T6, T7, T8, T9, T10)>, IEquatable<WeakActionEventHandler<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10>>
{
    ...
    /// <inheritdoc cref="IEventHandler{TNotification}.Handle"/>
    public void Handle((T1, T2, T3, T4, T5, T6, T7, T8, T9, T10) notification)
    {
        if (m_Owner.TryGetTarget(out var owner) && owner != null) m_Invocation.Invoke(notification.Item1, notification.Item2, notification.Item3, notification.Item4, notification.Item5, notification.Item6, notification.Item7, notification.Item8, notification.Item9, notification.Item10);
    }

    /// <inheritdoc cref="IEventHandler{TNotification}.Handle"/>
    public void Handle(T1 param1, T2 param2, T3 param3, T4 param4, T5 param5, T6 param6, T7 param7, T8 param8, T9 param9, T10 param10)
    {
        if (m_Owner.TryGetTarget(out var owner) && owner != null) m_Invocation.Invoke(param1, param2, param3, param4, param5, param6, param7, param8, param9, param10);
    }
...
public sealed class WeakActionEventHandler<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11> : IEventHandler<(T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11)>, IWeakEventHandler<(T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11)>, IEquatable<WeakActionEventHandler<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11>>
{
    ...
    /// <inheritdoc cref="IEventHandler{TNotification}.Handle"/>
    public void Handle((T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11) notification)
    {
        if (m_Owner.TryGetTarget(out var owner) && owner != null) m_Invocation.Invoke(notification.Item1, notification.Item2, notification.Item3, notification.Item4, notification.Item5, notification.Item6, notification.Item7, notification.Item8, notification.Item9, notification.Item10, notification.Item11);
    }

    /// <inheritdoc cref="IEventHandler{TNotification}.Handle"/>
    public void Handle(T1 param1, T2 param2, T3 param3, T4 param4, T5 param5, T6 param6, T7 param7, T8 param8, T9 param9, T10 param10, T11 param11)
    {
        if (m_Owner.TryGetTarget(out var owner) && owner != null) m_Invocation.Invoke(param1, param2, param3, param4, param5, param6, param7, param8, param9, param10, param11);
    }
...
public sealed class WeakActionEventHandler<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12> : IEventHandler<(T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12)>, IWeakEventHandler<(T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12)>, IEquatable<WeakActionEventHandler<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12>>
{
    ...
    {
        if (m_Owner.TryGetTarget(out var owner) && owner != null) m_Invocation.Invoke(notification.Item1, notification.Item2, notification.Item3, notification.Item4, notification.Item5, notification.Item6, notification.Item7, notification.Item8, notification.Item9, notification.Item10, notification.Item11, notification.Item12);
    }

    /// <inheritdoc cref="IEventHandler{TNotification}.Handle"/>
    public void Handle(T1 param1, T2 param2, T3 param3, T4 param4, T5 param5, T6 param6, T7 param7, T8 param8, T9 param9, T10 param10, T11 param11, T12 param12)
    {
        if (m_Owner.TryGetTarget(out var owner) && owner != null) m_Invocation.Invoke(param1, param2, param3, param4, param5, param6, param7, param8, param9, param10, param11, param12);
    }
...
public sealed class WeakActionEventHandler<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13> : IEventHandler<(T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13)>, IWeakEventHandler<(T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13)>, IEquatable<WeakActionEventHandler<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13>>
{
    ...
    /// <inheritdoc cref="IEventHandler{TNotification}.Handle"/>
    public void Handle((T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13) notification)
    {
        if (m_Owner.TryGetTarget(out var owner) && owner != null) m_Invocation.Invoke(notification.Item1, notification.Item2, notification.Item3, notification.Item4, notification.Item5, notification.Item6, notification.Item7, notification.Item8, notification.Item9, notification.Item10, notification.Item11, notification.Item12, notification.Item13);
    }

    /// <inheritdoc cref="IEventHandler{TNotification}.Handle"/>
    public void Handle(T1 param1, T2 param2, T3 param3, T4 param4, T5 param5, T6 param6, T7 param7, T8 param8, T9 param9, T10 param10, T11 param11, T12 param12, T13 param13)
    {
        if (m_Owner.TryGetTarget(out var owner) && owner != null) m_Invocation.Invoke(param1, param2, param3, param4, param5, param6, param7, param8, param9, param10, param11, param12, param13);
    }
...
public sealed class WeakActionEventHandler<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13, T14> : IEventHandler<(T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13, T14)>, IWeakEventHandler<(T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13, T14)>, IEquatable<WeakActionEventHandler<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13, T14>>
{
    ...
    /// <inheritdoc cref="IEventHandler{TNotification}.Handle"/>
    public void Handle((T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13, T14) notification)
    {
        if (m_Owner.TryGetTarget(out var owner) && owner != null) m_Invocation.Invoke(notification.Item1, notification.Item2, notification.Item3, notification.Item4, notification.Item5, notification.Item6, notification.Item7, notification.Item8, notification.Item9, notification.Item10, notification.Item11, notification.Item12, notification.Item13, notification.Item14);
    }

    /// <inheritdoc cref="IEventHandler{TNotification}.Handle"/>
    public void Handle(T1 param1, T2 param2, T3 param3, T4 param4, T5 param5, T6 param6, T7 param7, T8 param8, T9 param9, T10 param10, T11 param11, T12 param12, T13 param13, T14 param14)
    {
        if (m_Owner.TryGetTarget(out var owner) && owner != null) m_Invocation.Invoke(param1, param2, param3, param4, param5, param6, param7, param8, param9, param10, param11, param12, param13, param14);
    }
...
public sealed class WeakActionEventHandler<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13, T14, T15> : IEventHandler<(T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13, T14, T15)>, IWeakEventHandler<(T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13, T14, T15)>, IEquatable<WeakActionEventHandler<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13, T14, T15>>
{
    ...
    /// <inheritdoc cref="IEventHandler{TNotification}.Handle"/>
    public void Handle((T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13, T14, T15) notification)
    {
        if (m_Owner.TryGetTarget(out var owner) && owner != null) m_Invocation.Invoke(notification.Item1, notification.Item2, notification.Item3, notification.Item4, notification.Item5, notification.Item6, notification.Item7, notification.Item8, notification.Item9, notification.Item10, notification.Item11, notification.Item12, notification.Item13, notification.Item14, notification.Item15);
    }

    /// <inheritdoc cref="IEventHandler{TNotification}.Handle"/>
    public void Handle(T1 param1, T2 param2, T3 param3, T4 param4, T5 param5, T6 param6, T7 param7, T8 param8, T9 param9, T10 param10, T11 param11, T12 param12, T13 param13, T14 param14, T15 param15)
    {
        if (m_Owner.TryGetTarget(out var owner) && owner != null) m_Invocation.Invoke(param1, param2, param3, param4, param5, param6, param7, param8, param9, param10, param11, param12, param13, param14, param15);
    }
