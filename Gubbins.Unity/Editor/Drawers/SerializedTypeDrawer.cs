...
namespace Gubbins.Editor
{
    ...
    {
        private static readonly StyleLength s_LabelWidth = new(Length.Percent(39.5f));
        ...
        public override VisualElement CreatePropertyGUI(SerializedProperty property)
        {
            ...
            if (index < 0) index = 0;
            var dropdown = new DropdownField(property.displayName, types.ToList(), index);
            dropdown.labelElement.style.width = s_LabelWidth;
