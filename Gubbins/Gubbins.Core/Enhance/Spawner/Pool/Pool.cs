...
public class Pool<T> : IPool<T>
{
    ...
    /// <remarks>
    /// If supported, the instance is reset/cleared via <see cref="IResetable"/>, <see cref="IClearable"/>,
    ...
    public virtual void Recycle(T instance)
    {
        ...
        if (instance is IResetable reseter)
        {
            reseter.Reset();
        }
        else if (instance is IClearable clearer)
        {
            clearer.Clear();
        }
