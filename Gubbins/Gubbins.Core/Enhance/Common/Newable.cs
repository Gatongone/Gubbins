...
#pragma warning restore CS8603 // Possible null reference return.
    ...
    /// <summary>
    /// A factory implementation that creates instances using an ISpawner interface.
    /// </summary>
    /// <typeparam name="T">The type of object created by the factory.</typeparam>
    /// <param name="function">The factory instance used to create objects.</param>
    private class FactoryNewer<T>(ISpawner<T> function) : INewable
    {
#pragma warning disable CS8603 // Possible null reference return.
        /// <summary>
        /// Creates a new instance by calling the factory's Spawn method.
        /// </summary>
        /// <returns>A new instance created by the factory.</returns>
        public object New() => function.Spawn();
#pragma warning restore CS8603 // Possible null reference return.
    }
}